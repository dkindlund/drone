class ClientsController < ApplicationController
  active_scaffold :client do |config|
    ...
    config.list.columns = [:quick_clone_name, :snapshot_name, :client_status, :job_count, :created_at, :suspended_at, :host, :os, :application]
    ...
    # TODO: Disable sub-form editing for the following attributes.
    ...
    #config.columns[:jobs].ui_type = :select
    ...
    config.columns[:job_count].label = "# URLs"
